...
class CarlosIIICommit {
	...
	private function load_dependencies() {
         ...
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-CarlosIIIJCommitWidgetInscribe.php';
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_nopriv_CarlosIIICommit_inscribe', $plugin_admin, 'CarlosIIICommit_inscribe' );
        $this->loader->add_action( 'wp_ajax_CarlosIIICommit_inscribe', $plugin_admin, 'CarlosIIICommit_inscribe' );
